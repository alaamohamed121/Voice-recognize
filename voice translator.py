...
mainwindow = Tk()
mainwindow.title('alaa mohamed Text-To-Speech and Speech-To-Text Converter')
...
def TextToSpeech():
    ...
    texttospeechwindow.title('Text-to-Speech Converter by alaa mohamed')
    texttospeechwindow.geometry("500x500")
    texttospeechwindow.configure(bg='Blue')

    Label(texttospeechwindow, text='Text-to-Speech Converter by alaa mohamed',
...
def SpeechToText():
    ...
    speechtotextwindow.title('Speech-to-Text Converter by alaa mohamed')
    speechtotextwindow.geometry("500x500")
    speechtotextwindow.configure(bg='pink')

    Label(speechtotextwindow, text='Speech-to-Text Converter by alaa mohamed',
...
Label(mainwindow, text='alaa mohamed Text-To-Speech and Speech-To-Text Converter',
